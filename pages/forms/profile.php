        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="http://localhost/adminlte-master/dist/img/avatar5.png" alt="User profile picture">
              ...
              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Livros Emprestados</b> <a class="pull-right">2</a>
                </li>
              </ul>

                <a href="http://localhost/adminlte-master/pages/forms/listaClientes.php#desativados">Desativadoos</a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
