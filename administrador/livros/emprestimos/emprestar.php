<?php  
 ...
 public function cadastrar($dados){
  ...
  $devolucao = $dados['devolucao'];
   ...
   foreach ($id_livros as $livros) {
   	...
   	$resultado = $conexao->executar($sql2);
 ...
 public function devolver($id_livros, $id_emprestimos){


      $sql = "delete from livros_emprestimos where id_livros = '$id_livros' and id_emprestimos = '$id_emprestimos'";
      $conexao = new Conexao();
  ...
  public function quantidade($id_cliente){

     $sql = "select count(*) as quantidade from view_emprestimos where id_cliente = '$id_cliente'";
     $conexao = new Conexao();
  ...
  public function listarLivros(){
     ...
     $sql = "select * from livros WHERE quant >= 1 ";
     $conexao = new Conexao();
